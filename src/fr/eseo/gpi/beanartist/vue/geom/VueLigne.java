...
public class VueLigne extends VueForme {
	...
	public void affiche(Graphics2D g2d){
		...
		g2d.drawPolyline(new int[] {this.getForme().getX(), this.getForme().getX() + this.getForme().getLargeur()}, new int[] {this.getForme().getY(), this.getForme().getY() + this.getForme().getHauteur()}, 2);
	}
}
